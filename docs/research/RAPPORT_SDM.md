...
| 5. Runtime écosystème complet | Faire tourner la quasi-totalité du catalogue | ⚠ Théorique — les mixins client ciblent le client local, pas un runtime streamé | Très élevé |
